...
#ifndef vidtk_video_variable_image_erode_h_
#define vidtk_video_variable_image_erode_h_
...
///
/// Perform a variable erosion of the image, where we specify some source image,
...
///
/// Core [unsafe] implementation for performing a variable erosion, in either
/// a grayscale or binary image. So far this function only supports using basic
