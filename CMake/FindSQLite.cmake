...
elseif( NOT SQLite_FOUND )
  ...
  setup_find_root_context(SQLite)
  find_path( SQLite_INCLUDE_DIR sqlite3.h ${SQLite_FIND_OPTS})
  find_library( SQLite_LIBRARY sqlite3 ${SQLite_FIND_OPTS})
  restore_find_root_context(SQLite)
