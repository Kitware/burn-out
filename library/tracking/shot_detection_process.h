...
public:
  ...
  shot_detection_process( std::string const& name );
  ...
  void set_active_tracks( std::vector< klt_track_ptr > const& trks );
  VIDTK_INPUT_PORT( set_active_tracks, std::vector< klt_track_ptr > const& );

  void set_terminated_tracks( std::vector< klt_track_ptr > const& trks );
  VIDTK_INPUT_PORT( set_terminated_tracks, std::vector< klt_track_ptr > const& );
