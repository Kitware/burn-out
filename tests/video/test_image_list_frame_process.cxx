...
void
test_frame_count( vcl_string const& dir )
{
...
void
test_parse_frame_number( vcl_string const& dir )
{
...
void
test_parse_base_frame_number( vcl_string const& dir )
{
...
void
test_parse_both( vcl_string const& dir )
{
  vcl_cout << "\n\nTesting frame number parsing\n\n";
...
void
test_parse_time( vcl_string const& dir )
{
  vcl_cout << "\n\nTesting ROI setting\n\n";
...
void test_list_file_no_not_exist( vcl_string const & dir )
{
  vcl_cout << "\n\nTesting frame number increment\n\n";
...
void
test_file( vcl_string const& dir )
{
  vcl_cout << "\n\nTesting frame number increment\n\n";
