...
public:
  ...
  homography_writer_process( std::string const& name );
  ...
  void set_source_vidtk_homography( vidtk::homography const& H );
  VIDTK_INPUT_PORT( set_source_vidtk_homography, vidtk::homography const& );
