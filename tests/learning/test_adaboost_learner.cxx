...
void test_adaboost_stump()
{
  ...
  std::vector<vidtk::weak_learner_sptr> weak_learner_factories;
  ...
  ada.train_platt(training_examples);
  ...
  std::cout << number_positive/number_of_samples_per_class << " " << number_negative/number_of_samples_per_class << std::endl;
