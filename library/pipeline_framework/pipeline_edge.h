...
#ifndef vidtk_pipeline_edge_h_
#define vidtk_pipeline_edge_h_
...
struct pipeline_edge
{
  pipeline_node* from_;
  pipeline_node* to_;
  std::string from_port_name_;
  std::string to_port_name_;
  ...
  /// When applicable, returns the length of the queue for this edge.
