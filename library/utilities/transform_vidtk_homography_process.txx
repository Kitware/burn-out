...
::transform_vidtk_homography_process( vcl_string const& name )
  : process( name, "transform_vidtk_homography_process" )
{
...
::set_params( config_block const& blk )
{
  try
  {
    ...
    if( postmult_ )
    {
      ...
      vnl_matrix_fixed<double,3,3> M;
      M.copy_in( &v[0] );
      postmult_M_.set_transform( homography::transform_t(M) );
    }
...
::step()
{
  ...
  else
  {
    ...
    if(!is_set)
    {
      log_warning( this->name() << ": Failed to set premult_ transformation matrix" << vcl_endl );
    }
  }
  ...
  else
  {
    ...
    if(!is_set)
    {
      log_warning( this->name() << ": Failed to set postmult_ transformation matrix" << vcl_endl );
    }
  }
...
template< class InSrcType, class InDestType, class OutSrcType, class OutDestType >
typename transform_vidtk_homography_process< InSrcType, InDestType, OutSrcType, OutDestType >::out_homog_t const&
transform_vidtk_homography_process< InSrcType, InDestType, OutSrcType, OutDestType >
::homography() const
{
  return out_H_;
...
template< class InSrcType, class InDestType, class OutSrcType, class OutDestType >
typename transform_vidtk_homography_process< InSrcType, InDestType, OutSrcType, OutDestType >::inv_out_homog_t const&
transform_vidtk_homography_process< InSrcType, InDestType, OutSrcType, OutDestType >
...
template< class InSrcType, class InDestType, class OutSrcType, class OutDestType >
typename transform_vidtk_homography_process< InSrcType, InDestType, OutSrcType, OutDestType >::out_homog_t::transform_t const&
transform_vidtk_homography_process< InSrcType, InDestType, OutSrcType, OutDestType >
...
template< class InSrcType, class InDestType, class OutSrcType, class OutDestType >
typename transform_vidtk_homography_process< InSrcType, InDestType, OutSrcType, OutDestType >::inv_out_homog_t::transform_t const&
transform_vidtk_homography_process< InSrcType, InDestType, OutSrcType, OutDestType >
