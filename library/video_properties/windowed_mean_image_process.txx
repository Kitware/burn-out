...
#define VIDTK_DEFAULT_LOGGER __vidtk_logger_auto_windowed_mean_image_process_txx__
VIDTK_LOGGER("windowed_mean_image_process_txx");
...
::windowed_mean_image_process( std::string const& _name )
  : process( _name, "windowed_mean_image_process" ),
    radius_(0)
{
...
::set_params( config_block const& blk )
{
  try
  {
    radius_ = blk.get<unsigned>( "radius" );
  }
