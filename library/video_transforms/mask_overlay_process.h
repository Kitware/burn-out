...
public:
  ...
  mask_overlay_process( std::string const& name );

  virtual ~mask_overlay_process();
  ...
  vil_image_view<vxl_byte> image() const;
  VIDTK_OUTPUT_PORT( vil_image_view<vxl_byte>, image );
