  ...
  : public process
{
  ...
  do_something( std::string const& _name, unsigned max )
...
void
test_connect_no_execute_run()
{
  {
    sync_pipeline p;
    do_something n1( "n1", 5 );
    p.add_without_execute( &n1 );
...
int test_connect_no_execute_up( int /*argc*/, char* /*argv*/[] )
{
  testlib_test_start( "test_connect_no_execute_up" );
