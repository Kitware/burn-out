...
public:
  ...
  image_difference_no_bkgnd_process( std::string const& name );

  virtual ~image_difference_no_bkgnd_process();
...
protected:
  ...
  std::string dynamic_range_filename_;
  std::ifstream dynamic_range_file_;
