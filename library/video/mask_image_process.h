...
public:
  ...
  /// The copy of the image.
  vil_image_view<bool> const& copied_image() const;

  VIDTK_OUTPUT_PORT( vil_image_view<bool> const&, copied_image );
...
private:
  ...
  // This value will be writtne out in the 'masked pixels'.
  bool masked_value_;
