...
if(NOT EXISTS \"${MIDAS_DATA_DIR}/MIDAS_Hashes/${checksum}\")
  ...
  if(NOT \"${MIDAS_USER}\" STREQUAL \"\" AND NOT \"${MIDAS_DEFAULT_API_KEY}\" STREQUAL \"\")
    file(DOWNLOAD \"${MIDAS_REST_URL}?method=midas.login&email=${MIDAS_USER}&appname=Default&apikey=${MIDAS_DEFAULT_API_KEY}&format=json\" \"${MIDAS_DATA_DIR}/MIDAS_FetchScripts/MIDASToken.txt\" ${MIDAS_DOWNLOAD_TIMEOUT_STR} STATUS status TLS_CAINFO ${vidtk_source_dir}/CMake/kwcert.cer)
  ...
  file(DOWNLOAD \"${MIDAS_REST_URL}?method=midas.bitstream.download&checksum=${checksum}&algorithm=${hash_alg}\${tokenArg}\" \"${MIDAS_DATA_DIR}/MIDAS_Hashes/\${midas_test_name}_${checksum}\" ${MIDAS_DOWNLOAD_TIMEOUT_STR} STATUS status TLS_CAINFO ${vidtk_source_dir}/CMake/kwcert.cer)
  list(GET status 0 exitCode)
  list(GET status 1 errMsg)
  if(NOT exitCode EQUAL 0)
