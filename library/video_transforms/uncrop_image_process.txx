...
VIDTK_LOGGER("uncrop_image_process_txx");
...
::uncrop_image_process( std::string const& _name )
  : process( _name, "uncrop_image_process" )
{
...
::set_params( config_block const& blk )
{
  try
  {
    ...
    horizontal_pad_ = blk.get<unsigned>( "horizontal_padding" );
    vertical_pad_ = blk.get<unsigned>( "vertical_padding" );
    bkgnd_value_ = blk.get<PixType>( "background_value" );
  }
